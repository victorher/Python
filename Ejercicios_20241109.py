...
# 1. Mayor de Tres Números: Cargar tres números distintos por teclado y
...
# 2. Clasificación de Números: Ingresar un número entero y mostrar si es
# positivo,negativo o nulo (cero)
...
# Verificar Navidad: Crear un programa que pida una fecha y verifique si
# corresponde a Navidad (25 de diciembre)
...
# 4. Menores a Diez: Ingresar tres números. Si todos son menores a 10,
# imprimir "Todos los números son menores a diez".
# Si al menos uno es menor a 10, imprimir "Alguno de los números es
# menor a diez".
...
# 5. Contador hasta un Número: Codificar un programa que solicite un valor
# positivo e imprima los números del 1 hasta ese valor.
...
# 6. Suma y Promedio de Valores: Desarrollar un programa que pida la carga de
# 10 valores y luego muestre la suma y el promedio de esos valores.
...
def imprimir_numeros(i=1):
    if i > 50:
        return
    print(i)
    imprimir_numeros(i + 1)

    imprimir_numeros()

# 8. Intermedio: Desarrollar un programa que solicite la carga de 5 números e
...
# 9. Avanzado: Crear un programa que lea n pares de datos (base y altura)
# de triángulos, de informe la superficie de cada triángulo y cuántos tienen
# una superficie mayor a 12.
...
def calcular_superficie_triangulos():
    try:
        ...
        print(
            f"Número de triángulos con superficie mayor a 12: "
            f"{contador_mayores_a_12}"
        )
...
# 10. Básico: Crea una lista con 5 enteros y calcula la suma de todos sus
# elementos.
...
# 11. Intermedio: Define una lista que contenga los nombres de los primeros
# cuatro meses del año y muestra solo el primer y el último mes.


print(
    "\nDefine una lista que contenga los nombres de los primeros cuatro"
...
# 12. Avanzado: Crea una lista que almacene el nombre de un alumno y sus
# dos notas. Luego, imprime el nombre del alumno y el promedio de sus notas.
